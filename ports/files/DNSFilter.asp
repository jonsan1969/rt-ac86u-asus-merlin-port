...
function applyRule(){
	var serialized = dnsfilter_rule_list.replace(/&#62/g, ">");
	if (serialized.length > 255) {
		alert("ASUS 52334 stores DNS Director client rules in one 255-byte NVRAM field. Remove one or more client rules before applying.");
		return false;
	}
	document.form.dnsfilter_rulelist.value = serialized;
	showLoading();
...
<input type="hidden" name="action_script" value="restart_dnsmasq;restart_firewall">
	...
	<tr>
		...
		<div id="dnsfilter_desc" style="margin-bottom:10px;">
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="4" align="center" class="FormTable_table" style="margin-top:8px;" id="mainTable_Table">
				<thead><tr><td colspan="3"><#ConnectedClient#> - ASUS 52334 client-rule storage limit: 255 bytes</td></tr></thead>
				<tr>
